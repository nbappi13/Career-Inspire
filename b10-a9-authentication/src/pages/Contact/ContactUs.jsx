...
const ContactUs = () => {
    ...
    return (
        <HelmetProvider>
            <Helmet>
                <title>Contact Us - Career Inspire</title>
                <meta name="description" content="We'd love to hear from you! Whether you have questions, feedback, or need support, feel free to get in touch with us." />
            </Helmet>
