...
const Resources = () => {
    return (
        <HelmetProvider>
            <Helmet>
                <title>Career Resources - Career Inspire</title>
                <meta name="description" content="Empower your career journey with curated resources designed to inspire and guide you toward success." />
            </Helmet>
